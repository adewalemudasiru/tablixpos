...
const DEFAULT_CATEGORIES = [
  { id: "cat-1", name: "Burgers", description: "Juicy handcrafted burgers", active: true, isActive: true },
  { id: "cat-2", name: "Appetizers", description: "Start your meal right", active: true, isActive: true },
  { id: "cat-3", name: "Pizza", description: "Wood-fired oven pizzas", active: true, isActive: true },
  { id: "cat-4", name: "Pasta", description: "Italian classic pastas", active: true, isActive: true },
  { id: "cat-5", name: "Sides", description: "Extra accompaniments", active: true, isActive: true },
  { id: "cat-6", name: "Drinks", description: "Cold beverages", active: true, isActive: true },
  { id: "cat-7", name: "Desserts", description: "Sweet treats", active: true, isActive: true },
  { id: "cat-8", name: "Salads", description: "Healthy fresh green salads", active: true, isActive: true },
  { id: "cat-9", name: "Cocktails", description: "Refreshing craft cocktails and mocktails", active: true, isActive: true },
  { id: "cat-10", name: "Seafood", description: "Fresh catch and ocean delights", active: true, isActive: true }
];
...
const DEFAULT_TABLES = [
  { id: "tbl-1", name: "Table 1", seats: 4, zone: "Main Floor", status: "available", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-2", name: "Table 2", seats: 2, zone: "Main Floor", status: "occupied", occupiedAt: new Date(Date.now() - 30*60*1000).toISOString(), customerName: "Alice Johnson", orderTotal: 13975, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-3", name: "Table 3", seats: 6, zone: "VIP", status: "reserved", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-4", name: "Table 4", seats: 4, zone: "Patio", status: "available", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-5", name: "Table 5", seats: 2, zone: "Patio", status: "bill_requested", occupiedAt: new Date(Date.now() - 45*60*1000).toISOString(), customerName: "Bob Williams", orderTotal: 13437, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-6", name: "Table 6", seats: 8, zone: "VIP", status: "available", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-7", name: "Table 7", seats: 4, zone: "Main Floor", status: "available", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() },
  { id: "tbl-8", name: "Table 8", seats: 2, zone: "Main Floor", status: "available", occupiedAt: null, customerName: null, orderTotal: null, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }
];

const DEFAULT_STAFF = [
  { id: "staff-1", name: "Admin", email: "admin@tablix.com", role: "Admin", pin: "000000", dateCreated: new Date().toISOString(), isActive: true, createdAt: new Date().toISOString() },
  { id: "staff-2", name: "John Cashier", email: "john@tablix.com", role: "Cashier", pin: "123456", dateCreated: new Date().toISOString(), isActive: true, createdAt: new Date().toISOString() },
  { id: "staff-3", name: "Jane Waiter", email: "jane@tablix.com", role: "Waiter", pin: "222222", dateCreated: new Date().toISOString(), isActive: true, createdAt: new Date().toISOString() },
  { id: "staff-4", name: "Chef Mario", email: "mario@tablix.com", role: "Chef", pin: "333333", dateCreated: new Date().toISOString(), isActive: true, createdAt: new Date().toISOString() }
];
...
const DEFAULT_CUSTOMERS = [
  { id: "cust-1", firstName: "Alice", lastName: "Johnson", name: "Alice Johnson", phone: "08011112222", email: "alice@example.com", totalSpent: 45000, visitCount: 5, lastVisit: new Date().toISOString().split("T")[0], joinDate: new Date(Date.now() - 30*24*60*60*1000).toISOString().split("T")[0], loyaltyPoints: 450, createdAt: new Date(Date.now() - 30*24*60*60*1000).toISOString() },
  { id: "cust-2", firstName: "Bob", lastName: "Williams", name: "Bob Williams", phone: "08033334444", email: "bob@example.com", totalSpent: 12000, visitCount: 2, lastVisit: new Date().toISOString().split("T")[0], joinDate: new Date(Date.now() - 10*24*60*60*1000).toISOString().split("T")[0], loyaltyPoints: 120, createdAt: new Date(Date.now() - 10*24*60*60*1000).toISOString() },
  { id: "cust-3", firstName: "Charlie", lastName: "Brown", name: "Charlie Brown", phone: "08055556666", email: "charlie@example.com", totalSpent: 35000, visitCount: 4, lastVisit: new Date().toISOString().split("T")[0], joinDate: new Date(Date.now() - 25*24*60*60*1000).toISOString().split("T")[0], loyaltyPoints: 350, createdAt: new Date(Date.now() - 25*24*60*60*1000).toISOString() },
  { id: "cust-4", firstName: "Diana", lastName: "Prince", name: "Diana Prince", phone: "08077778888", email: "diana@example.com", totalSpent: 75000, visitCount: 8, lastVisit: new Date().toISOString().split("T")[0], joinDate: new Date(Date.now() - 40*24*60*60*1000).toISOString().split("T")[0], loyaltyPoints: 750, createdAt: new Date(Date.now() - 40*24*60*60*1000).toISOString() },
  { id: "cust-5", firstName: "Evan", lastName: "Wright", name: "Evan Wright", phone: "08099990000", email: "evan@example.com", totalSpent: 8000, visitCount: 1, lastVisit: new Date().toISOString().split("T")[0], joinDate: new Date(Date.now() - 2*24*60*60*1000).toISOString().split("T")[0], loyaltyPoints: 80, createdAt: new Date(Date.now() - 2*24*60*60*1000).toISOString() }
];

const DEFAULT_SUPPLIERS = [
  { id: "sup-1", name: "Meat Co", contactPerson: "John Smith", phone: "08012345678", email: "john@meatco.com", address: "12 Carnivore Rd, Lagos", itemsSupplied: "Beef Patty, Pepperoni Slices, Chicken Breast", totalOrders: 15, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-2", name: "Local Bakery", contactPerson: "Jane Doe", phone: "08087654321", email: "orders@bakery.com", address: "34 Flour Ave, Lagos", itemsSupplied: "Burger Buns, Pizza Dough", totalOrders: 8, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-3", name: "BevDistributors", contactPerson: "Mike G", phone: "08011223344", email: "mike@bevdist.com", address: "78 Liquid Way, Lagos", itemsSupplied: "Coke Cans", totalOrders: 12, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-4", name: "Dairy Fresh", contactPerson: "Sarah K", phone: "08055667788", email: "sarah@dairyfresh.com", address: "9 Milk Lane, Lagos", itemsSupplied: "Mozzarella Cheese, Cooking Cream", totalOrders: 6, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-5", name: "Veggie Farm", contactPerson: "Tunde O", phone: "08099887766", email: "tunde@veggiefarm.com", address: "Farmer Market, Lagos", itemsSupplied: "Potatoes, Lettuce, Tomatoes", totalOrders: 10, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-6", name: "Spice & Flavor", contactPerson: "Aisha M", phone: "08022334455", email: "aisha@spiceflavor.com", address: "7 Pepper Lane, Lagos", itemsSupplied: "Coffee Beans", totalOrders: 5, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-7", name: "Seafood Express", contactPerson: "Emeka N", phone: "08077889900", email: "emeka@seafoodex.com", address: "Marina Wharf, Lagos", itemsSupplied: "Salmon Fillets, Prawns", totalOrders: 4, status: "Active", createdAt: new Date().toISOString() },
  { id: "sup-8", name: "Global Foods", contactPerson: "Victor C", phone: "08033445566", email: "victor@globalfoods.com", address: "5 Warehouse Rd, Lagos", itemsSupplied: "Pasta Spaghetti, Cooking Oil", totalOrders: 18, status: "Active", createdAt: new Date().toISOString() }
];
...
const DEFAULT_EXPENSES = [
  ...
  { id: "exp-6", description: "Restaurant Cleaning Supplies", amount: 8000, category: "Other", expenseDate: new Date().toISOString().split("T")[0], date: new Date().toISOString().split("T")[0], paidBy: "Owner", vendor: "Supermarket", status: "Approved", paymentMethod: "Cash", notes: "Soap, sanitizer, garbage bags", createdAt: new Date().toISOString() },
...
const DEFAULT_KDS_ORDERS = [
  {
    id: "kds-1", orderNo: "001", tableNo: "Table 2", customer: "Alice Johnson", status: "New",
  ...
  {
    id: "kds-2", orderNo: "002", tableNo: "Table 5", customer: "Bob Williams", status: "InProgress",
  ...
  {
    id: "kds-3", orderNo: "003", tableNo: "Table 1", customer: "Walk-in", status: "Ready",
...
function initializeDatabase() {
  ...
  if (!rawStore) {
    const defaultStore = {
      ...
      taxConfig: { enabled: true, name: "VAT", rate: 7.5, inclusive: false, serviceCharge: true, serviceRate: 5, showOnReceipt: true },
      posConfig: { receiptHeader: "Welcome to Tablix POS", receiptFooter: "Thank you for your patronage!", printerType: "Thermal", paperWidth: "80mm", autoPrint: true, showQR: true, showLogo: true, tipsEnabled: true, cashRounding: false, requireCustomer: false },
      businessConfig: { tagline: "Serving quality, one plate at a time", address: "12B Victoria Island Boulevard", city: "Lagos", state: "Lagos State", phone: "+234 801 234 5678", email: "hello@tablixkitchen.ng", website: "www.tablixkitchen.ng", type: "Restaurant", rcNumber: "RC-123456" },
      loyaltyConfig: { enabled: true, rewardType: "percentage", rewardValue: 5, threshold: 100, minPointsToRedeem: 50, showBalanceOnReceipt: true, autoEnroll: true },
      logo: null,
    };
...
export async function handleMockRequest(url: string, init?: RequestInit): Promise<Response> {
  ...
  // Helper responses
  const ok = (data: any = {}) => new Response(JSON.stringify({ success: true, data }), { status: 200, headers: { "Content-Type": "application/json" } });
  const success = (message: string) => new Response(JSON.stringify({ success: true, message }), { status: 200, headers: { "Content-Type": "application/json" } });
  const error = (message: string, status = 400) => new Response(JSON.stringify({ success: false, error: message, message }), { status, headers: { "Content-Type": "application/json" } });
  ...
  if (path.startsWith("/api/v1/auth/")) {
    ...
    if (authPath === "signup" && method === "POST") {
      ...
      return ok({ user: newUser, accessToken: "mock-access-token", refreshToken: "mock-refresh-token" });
    }
    ...
    if (authPath === "login" && method === "POST") {
      ...
      if (body.email === u.email && body.pin === storedPin) {
        ...
        localStorage.setItem("tablix_business_id", "business-1");
        return ok({ user: u, accessToken: "mock-access-token", refreshToken: "mock-refresh-token" });
      }
  ...
  if (path.startsWith("/api/v1/staff")) {
    ...
    if (idMatch) {
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          store.staff[idx] = { ...store.staff[idx], ...body, updatedAt: new Date().toISOString() };
          saveStore(store);
  ...
  if (path.startsWith("/api/v1/menu/categories")) {
    ...
    if (catPath === "" || catPath === "/") {
      if (method === "GET") {
        return ok({ categories: store.menuCategories.map((c: any) => ({ ...c, isActive: c.active !== false })) });
      }
      if (method === "POST") {
        const newCat = {
          id: `cat-${Date.now()}`,
    ...
    if (idMatch) {
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          ...
          saveStore(store);
          return ok({ category: { ...store.menuCategories[idx], isActive: store.menuCategories[idx].active } });
        }
        if (method === "DELETE") {
  ...
  if (path.startsWith("/api/v1/menu/items")) {
      ...
      if (method === "GET") {
        return ok({
          items: store.menuItems.map((i: any) => ({
            ...
            categoryId: store.menuCategories.find((c: any) => c.name === i.category)?.id || null,
            imageUrl: i.image || "",
          })),
        });
      }
      if (method === "POST") {
        const categoryName = body.categoryId ? store.menuCategories.find((c: any) => c.id === body.categoryId)?.name || "" : "";
        const newItem = {
          id: `item-${Date.now()}`,
          name: body.name,
          price: body.price,
        ...
        saveStore(store);
        return ok({ item: { ...newItem, categoryName, imageUrl: newItem.image } });
      }
    }
    ...
    if (idMatch) {
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          const categoryName = body.categoryId ? store.menuCategories.find((c: any) => c.id === body.categoryId)?.name || store.menuItems[idx].category : store.menuItems[idx].category;
          store.menuItems[idx] = { ...store.menuItems[idx], ...body, category: categoryName, image: body.imageUrl !== undefined ? body.imageUrl : store.menuItems[idx].image };
          saveStore(store);
          return ok({ item: { ...store.menuItems[idx], categoryName, imageUrl: store.menuItems[idx].image } });
        }
        if (method === "DELETE") {
  ...
  if (path.startsWith("/api/v1/tables")) {
    ...
    if (idMatch) {
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          store.tables[idx] = { ...store.tables[idx], ...body, updatedAt: new Date().toISOString() };
          saveStore(store);
  ...
  if (path.startsWith("/api/v1/inventory")) {
    ...
    if (invPath === "" || invPath === "/") {
      if (method === "GET") {
        return ok({
          ...
          pagination: { page: 1, limit: 100, total: store.inventoryItems.length, totalPages: 1 },
        });
      }
      if (method === "POST") {
        const newItem = {
          ...
          status: (body.currentStock || 0) <= (body.reorderLevel || 5) ? "Low Stock" : "Active",
        };
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          const updated = {
            ...
            name: body.name !== undefined ? body.name : store.inventoryItems[idx].name,
            unit: body.unit !== undefined ? body.unit : store.inventoryItems[idx].unit,
            qty: body.currentStock !== undefined ? body.currentStock : store.inventoryItems[idx].qty,
            minQty: body.reorderLevel !== undefined ? body.reorderLevel : store.inventoryItems[idx].minQty,
            costPerUnit: body.unitCost !== undefined ? body.unitCost : store.inventoryItems[idx].costPerUnit,
            supplier: body.supplier !== undefined ? body.supplier : store.inventoryItems[idx].supplier,
          };
          updated.status = updated.qty <= 0 ? "Out of Stock" : updated.qty <= updated.minQty ? "Low Stock" : "Active";
    ...
    if (logMatch && method === "POST") {
      ...
      if (idx !== -1) {
        ...
        else if (body.type === "StockOut" || body.type === "Adjustment" || body.type === "Wastage") newStock -= body.quantity;
        
        item.qty = newStock;
        item.status = newStock <= 0 ? "Out of Stock" : newStock <= item.minQty ? "Low Stock" : "Active";
    ...
    if (logsMatch && method === "GET") {
      ...
      const logs = store.inventoryLog.filter((log: any) => log.itemName === item?.name).map((log: any) => ({
        id: log.id,
    ...
    if (custPath === "" || custPath === "/") {
      if (method === "GET") {
        return ok({
          ...
          pagination: { page: 1, limit: 100, total: store.customers.length, totalPages: 1 },
        });
      }
      if (method === "POST") {
        const newCust = {
      ...
      if (idx !== -1) {
        if (method === "PUT") {
          const updated = {
            ...store.customers[idx],
            ...body,
            name: body.firstName || body.lastName ? `${body.firstName || store.customers[idx].firstName || ""} ${body.lastName || store.customers[idx].lastName || ""}` : store.customers[idx].name,
          };
    ...
    if (expPath === "" || expPath === "/") {
      if (method === "GET") {
        return ok({
          ...
          pagination: { page: 1, limit: 100, total: store.expenses.length, totalPages: 1 },
        });
      }
      if (method === "POST") {
        const newExp = {
  ...
  if (path.startsWith("/api/v1/orders")) {
    ...
    if (orderPath === "" || orderPath === "/") {
      if (method === "GET") {
        const mappedOrders = transactions.map((t: any) => ({
          id: t.id,
          status: t.status === "completed" ? "Served" : t.status === "voided" ? "Cancelled" : "Pending",
        ...
        return ok({
          orders: mappedOrders,
          pagination: { page: 1, limit: 100, total: mappedOrders.length, totalPages: 1 },
        });
      }
      ...
      if (method === "POST") {
        ...
        const itemsList = body.items.map((i: any) => {
          const menuItem = store.menuItems.find((m: any) => m.id === i.menuItemId);
          return {
            id: i.menuItemId,
        ...
        const subtotal = itemsList.reduce((acc: number, cur: any) => acc + (cur.price * cur.qty), 0);
        const taxRate = store.taxConfig.enabled ? store.taxConfig.rate : 0;
        const tax = subtotal * (taxRate / 100);
        const serviceCharge = store.taxConfig.serviceCharge ? subtotal * (store.taxConfig.serviceRate / 100) : 0;
        const total = subtotal + tax + serviceCharge;

        const customerObj = body.customerId ? store.customers.find((c: any) => c.id === body.customerId) : null;
        ...
        if (store.posConfig.kotEnabled || true) {
          const kdsOrder = {
            ...
            tableNo: body.tableId ? store.tables.find((t: any) => t.id === body.tableId)?.name || "—" : "—",
    ...
    if (idMatch) {
      ...
      if (tx) {
        if (method === "GET") {
          return ok({
            order: {
              id: tx.id,
              status: tx.status === "completed" ? "Served" : tx.status === "voided" ? "Cancelled" : "Pending",
      ...
      if (statusMatch && method === "PUT") {
        ...
        if (txIndex !== -1) {
          transactions[txIndex].status = body.status === "Served" ? "completed" : body.status === "Cancelled" ? "voided" : "pending";
          saveTransactions(transactions);
          return ok({
            order: {
              ...transactions[txIndex],
              status: body.status,
              paymentStatus: transactions[txIndex].status === "completed" ? "Completed" : "Unpaid",
              items: [],
              createdAt: new Date().toISOString(),
            },
          });
      ...
      if (payMatch && method === "POST") {
        ...
        if (txIndex !== -1) {
          ...
          if (customerId && customerId !== "walk-in") {
            const custIdx = store.customers.findIndex((c: any) => c.id === customerId);
            if (custIdx !== -1) {
              const pointsEarned = Math.floor(transactions[txIndex].total * (store.loyaltyConfig.rewardValue / 100));
              ...
              store.customers[custIdx].lastVisit = new Date().toISOString().split("T")[0];
              saveStore(store);
            }
          }
  ...
  if (path.startsWith("/api/v1/transactions")) {
    if (method === "GET") {
      ...
      return ok({
        transactions: mapped,
        pagination: { page: 1, limit: 100, total: mapped.length, totalPages: 1 },
      });
    }
  }
  ...
  if (path.startsWith("/api/v1/settings")) {
    ...
    if (method === "PUT") {
      if (body.taxEnabled !== undefined) store.taxConfig.enabled = body.taxEnabled;
      if (body.taxName !== undefined) store.taxConfig.name = body.taxName;
      if (body.taxRate !== undefined) store.taxConfig.rate = body.taxRate;
      if (body.taxInclusive !== undefined) store.taxConfig.inclusive = body.taxInclusive;
      if (body.taxOnReceipt !== undefined) store.taxConfig.showOnReceipt = body.taxOnReceipt;
      if (body.serviceCharge !== undefined) store.taxConfig.serviceCharge = body.serviceCharge;
      if (body.serviceRate !== undefined) store.taxConfig.serviceRate = body.serviceRate;
      if (body.loyaltyEnabled !== undefined) store.loyaltyConfig.enabled = body.loyaltyEnabled;
      if (body.loyaltyRewardType !== undefined) store.loyaltyConfig.rewardType = body.loyaltyRewardType;
      if (body.loyaltyRewardValue !== undefined) store.loyaltyConfig.rewardValue = body.loyaltyRewardValue;
      if (body.loyaltyThreshold !== undefined) store.loyaltyConfig.threshold = body.loyaltyThreshold;
      if (body.loyaltyMinRedeem !== undefined) store.loyaltyConfig.minPointsToRedeem = body.loyaltyMinRedeem;
      if (body.loyaltyShowOnReceipt !== undefined) store.loyaltyConfig.showBalanceOnReceipt = body.loyaltyShowOnReceipt;
      if (body.loyaltyAutoEnroll !== undefined) store.loyaltyConfig.autoEnroll = body.loyaltyAutoEnroll;
      if (body.receiptHeader !== undefined) store.posConfig.receiptHeader = body.receiptHeader;
      if (body.receiptFooter !== undefined) store.posConfig.receiptFooter = body.receiptFooter;
      if (body.printerType !== undefined) store.posConfig.printerType = body.printerType;
      if (body.paperWidth !== undefined) store.posConfig.paperWidth = body.paperWidth;
      if (body.autoPrint !== undefined) store.posConfig.autoPrint = body.autoPrint;
      ...
      if (body.tipsEnabled !== undefined) store.posConfig.tipsEnabled = body.tipsEnabled;
      if (body.cashRounding !== undefined) store.posConfig.cashRounding = body.cashRounding;
      if (body.requireCustomer !== undefined) store.posConfig.requireCustomer = body.requireCustomer;
      ...
      if (body.tablesEnabled !== undefined) {
        ...
        localStorage.setItem("tablix_tables_enabled", String(body.tablesEnabled));
      }
      saveStore(store);
  ...
  if (path.startsWith("/api/v1/subscriptions")) {
    ...
    if (subPath.startsWith("/verify") && method === "POST") {
      ...
      return ok({ plan: "pro", expiresAt: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString() });
    }
  ...
  // ─── Public Menu Route ───
  const publicMenuMatch = /^\/api\/v1\/menu\/public\/([a-zA-Z0-9_-]+)/.exec(path);
  ...
  if (path.startsWith("/api/v1/inventory-logs")) {
    ...
    if (method === "POST") {
      const newLog = { id: `log_${Date.now()}`, timestamp: new Date().toISOString(), ...body };
  ...
  if (path.startsWith("/api/v1/customers")) {
    ...
    if (cPath === "" || cPath === "/") {
      ...
      if (method === "POST") {
        const newCus = { id: `cus_${Date.now()}`, createdAt: new Date().toISOString(), points: 0, totalSpent: 0, visits: 0, lastVisit: null, ...body };
  ...
  if (path.startsWith("/api/v1/expenses")) {
    ...
    if (ePath === "" || ePath === "/") {
      ...
      if (method === "POST") {
        const newExp = { id: `exp_${Date.now()}`, createdAt: new Date().toISOString(), ...body };
