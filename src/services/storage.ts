...
export function downloadCSV(
  csv: string,
  filename: string = "tablix-transactions.csv"
): void {
  ...
  try {
    ...
    const mockTx: Transaction[] = [
      // Today (spanning morning to evening)
      {
        ...
        items: [
          { id: "menu-1", name: "Classic Cheeseburger", price: 5500, qty: 2 },
          { id: "menu-4", name: "Coca Cola (Can)", price: 1000, qty: 2 },
        ],
        customer: { id: "cust-1", name: "Alice Johnson", phone: "08011112222" },
        subtotal: 13000,
        vat: 975,
        total: 13975,
        paymentMethod: "cash",
      ...
      },
      {
        ...
        items: [
          { id: "menu-3", name: "Margarita Pizza", price: 8500, qty: 1 },
          { id: "menu-2", name: "Chicken Wings (6pcs)", price: 4000, qty: 1 },
        ],
        customer: { id: "cust-2", name: "Bob Williams", phone: "08033334444" },
        subtotal: 12500,
        vat: 937,
        total: 13437,
        paymentMethod: "card",
      ...
      },
      {
        ...
        items: [
          { id: "menu-1b", name: "BBQ Bacon Burger", price: 6500, qty: 1 },
          { id: "menu-6", name: "French Fries", price: 2000, qty: 2 },
        ],
        customer: { id: "walkin", name: "Walk-in" },
        subtotal: 10500,
        vat: 788,
        total: 11288,
      ...
      },
      {
        ...
        items: [
          { id: "menu-5", name: "Spaghetti Bolognese", price: 7500, qty: 2 },
      ...
      },
      {
        ...
        items: [
          { id: "menu-3b", name: "Pepperoni Pizza", price: 9500, qty: 1 },
          { id: "menu-7", name: "Chocolate Lava Cake", price: 3500, qty: 2 },
        ],
        customer: { id: "cust-4", name: "Diana Prince" },
        subtotal: 16500,
        vat: 1238,
        total: 17738,
        paymentMethod: "transfer",
      ...
      },
      {
        ...
        items: [
          { id: "menu-2b", name: "Mozzarella Sticks", price: 3500, qty: 3 },
          { id: "menu-4", name: "Coca Cola (Can)", price: 1000, qty: 3 },
        ],
        customer: { id: "walkin", name: "Walk-in" },
        subtotal: 13500,
        vat: 1013,
      ...
      {
        id: "tx-007",
        timestamp: now - day - 1 * 60 * 60 * 1000,
        items: [
          { id: "menu-1", name: "Classic Cheeseburger", price: 5500, qty: 1 },
          { id: "menu-6", name: "French Fries", price: 2000, qty: 1 },
        ],
      ...
      {
        id: "tx-008",
        timestamp: now - day - 3 * 60 * 60 * 1000,
        items: [{ id: "menu-3", name: "Margarita Pizza", price: 8500, qty: 2 }],
        customer: { id: "cust-5", name: "Evan Wright" },
        subtotal: 17000,
        vat: 1275,
        total: 18275,
        paymentMethod: "card",
      ...
      {
        id: "tx-009",
        timestamp: now - day - 6 * 60 * 60 * 1000,
        items: [
          { id: "menu-2", name: "Chicken Wings (6pcs)", price: 4000, qty: 2 },
          { id: "menu-4b", name: "Fresh Orange Juice", price: 2000, qty: 2 },
        ],
        customer: { id: "walkin", name: "Walk-in" },
        subtotal: 12000,
      ...
      {
        id: "tx-010",
        timestamp: now - day - 10 * 60 * 60 * 1000,
        items: [
          { id: "menu-1b", name: "BBQ Bacon Burger", price: 6500, qty: 3 },
        ],
        customer: { id: "cust-4", name: "Diana Prince" },
        subtotal: 19500,
        vat: 1463,
      ...
      // 2 Days ago
      {
        ...
        items: [
          { id: "menu-5", name: "Spaghetti Bolognese", price: 7500, qty: 1 },
          { id: "menu-7", name: "Chocolate Lava Cake", price: 3500, qty: 1 },
        ],
        customer: { id: "cust-2", name: "Bob Williams" },
        subtotal: 11000,
        vat: 825,
        total: 11825,
        paymentMethod: "cash",
      ...
      {
        id: "tx-012",
        timestamp: now - 2 * day - 5 * 60 * 60 * 1000,
        items: [
          { id: "menu-2", name: "Chicken Wings (6pcs)", price: 4000, qty: 3 },
        ],
        customer: { id: "walkin", name: "Walk-in" },
        subtotal: 12000,
        vat: 900,
        ...
        cashier: "John Cashier",
        status: "voided",
        voidedAt: now - 2 * day - 4.5 * 60 * 60 * 1000,
        voidedBy: "Admin",
        taxLabel: "VAT",
        taxRate: 7.5,
      },
      {
        id: "tx-013",
        timestamp: now - 2 * day - 8 * 60 * 60 * 1000,
        items: [
          { id: "menu-3b", name: "Pepperoni Pizza", price: 9500, qty: 2 },
          { id: "menu-4", name: "Coca Cola (Can)", price: 1000, qty: 4 },
        ],
        customer: { id: "cust-3", name: "Charlie Brown" },
        subtotal: 23000,
        vat: 1725,
      ...
      {
        id: "tx-014",
        timestamp: now - 3 * day - 4 * 60 * 60 * 1000,
        items: [
          { id: "menu-1", name: "Classic Cheeseburger", price: 5500, qty: 4 },
          { id: "menu-2", name: "Chicken Wings (6pcs)", price: 4000, qty: 2 },
          { id: "menu-4", name: "Coca Cola (Can)", price: 1000, qty: 5 },
        ],
        customer: { id: "cust-1", name: "Alice Johnson" },
        subtotal: 35000,
        vat: 2625,
      ...
      {
        id: "tx-015",
        timestamp: now - 3 * day - 7 * 60 * 60 * 1000,
        items: [
          { id: "menu-3", name: "Margarita Pizza", price: 8500, qty: 1 },
          { id: "menu-6", name: "French Fries", price: 2000, qty: 2 },
        ],
