import svgPaths from "./svg-41vw5kf810";
...
import imgContainer4 from "figma:asset/08c56e9db0787969efcded06d174345c1ff80c0f.png";
...
function Crt() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col h-[960px] items-start right-0 top-0 w-[384px]" data-name="Crt">
      <Container />
      <Container1 />
      <Container9 />
    </div>
...
function Group() {
  return (
    <div className="absolute inset-[16.67%_14.88%_20.23%_16.67%]" data-name="Group">
      <div className="absolute inset-[-4.22%_-3.89%_-4.22%_-3.9%]">
...
function Frame2() {
  return (
    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full">
      <div className="bg-white content-stretch flex flex-col items-start p-px relative rounded-[14px] shrink-0 w-[194px]" data-name="Product">
        <div aria-hidden="true" className="absolute border border-[#d0d5dd] border-solid inset-0 pointer-events-none rounded-[14px]" />
        <Container11 />
      </div>
      <div className="bg-white content-stretch flex flex-col items-start p-px relative rounded-[14px] shrink-0 w-[194px]" data-name="Product">
...
function Container20() {
  return (
    <div className="h-[145.664px] relative rounded-[10px] shrink-0 w-full" data-name="Container">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[10px] size-full" src={imgContainer4} />
      <div className="flex flex-row items-center justify-center size-full">
        <div className="size-full" />
      </div>
    </div>
...
function Heading5() {
  return (
    <div className="h-[20px] overflow-clip relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[20px] left-0 not-italic text-[#111827] text-[14px] top-[0.5px] tracking-[-0.1504px] whitespace-nowrap">Crunchy Chicken Burger</p>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start p-[12px] relative w-full">
        <Container20 />
        <Heading5 />
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[#111827] text-[16px] tracking-[-0.3125px] whitespace-nowrap">₦18,000</p>
        <div className="bg-[#e91835] relative rounded-[8px] shrink-0 w-full" data-name="_Button base">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className="content-stretch flex gap-[8px] items-center justify-center px-[14px] py-[8px] relative w-full">
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-white whitespace-nowrap">Add to Cart</p>
...
function Frame7() {
  return (
    <div className="h-[739px] relative shrink-0 w-full">
...
function Container10() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[24px] h-[844px] items-start overflow-x-auto overflow-y-clip p-[17px] relative rounded-[14px] shrink-0 w-[869px]" data-name="Container">
      <div className="h-[37px] relative shrink-0 w-full" data-name="New Search">
...
function Frame8() {
  return (
    <div className="absolute content-stretch flex items-start justify-between left-[21px] top-[87px] w-[1013px]">
      <div className="backdrop-blur-[8px] bg-white content-stretch flex flex-col gap-[15px] items-center justify-center p-[15px] relative rounded-[8px] shrink-0 w-[123px]" data-name="food side bar">
...
function Header() {
  return (
    <div className="absolute bg-white content-stretch flex h-[69px] items-center left-0 pl-[24px] pr-[40px] py-[20px] top-0 w-[1056px]" data-name="Header">
      <div aria-hidden="true" className="absolute border-[#d0d5dd] border-b border-solid inset-0 pointer-events-none" />
      <Frame3 />
    </div>
  );
...
export default function SurfacePro() {
  return (
    <div className="bg-[#f9fafb] relative size-full" data-name="Surface Pro 8 - 1">
      <Crt />
      <Frame8 />
      <Header />
    </div>
