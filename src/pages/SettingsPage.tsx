...
const TAB_ICONS: Record<SettingsTab, React.ReactNode> = {
  ...
  "Kitchen Order": (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M3 2h18M3 8h18M3 14h12M3 20h8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <circle cx="19" cy="19" r="3" stroke="currentColor" strokeWidth="1.8" />
      <path d="M19 17.5v1.5l1 1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
    </svg>
  ),
  "Table Management": (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path d="M2 7h20M2 13h20M5 13v6M19 13v6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
  "Tax Settings": (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
  ...
  "Menu QR Code": (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      <path d="M14 14h2v2h-2zM18 14h3M18 18h3M14 18v3M18 16h2v2" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  ),
};
...
export default function SettingsPage() {
  ...
  return (
    <SettingsShell activeTab={activeTab} onTabChange={setActiveTab} tabs={SETTINGS_TABS} tabIcons={TAB_ICONS}>
      {content}
    </SettingsShell>
  );
}
